...
Section Tests.
  ...
  Goal forall (w: word) (in1 in2: Z),
      0 <= in1 < 10 ->
      0 <= in2 < 20 ->
      \[w] = \[if Z.ltb in1 in2 then /[in1] else (/[in2] : word)] ->
      \[w] < 20.
  Proof. intros. rzify_lia. Succeed Qed. Abort.
  ...
  Goal forall (w: word) (in1 in2 in3 in4: Z),
      ...
      \[w] = \[if Z.ltb in1 in2
               ...
               else if Z.ltb in1 in3 then /[in3] else (/[in4] : word)] ->
      \[w] < 40.
  Proof. intros. rzify_lia. Succeed Qed. Abort.

  Goal forall (in0 in1: Z),
      (/[in0] : word) <> /[in1] ->
      (negb (Zmod.eqb /[in0] (/[in1] : word)))%bool = true.
  Proof. intros. rzify_lia. Succeed Qed. Abort.

  Goal forall (in0 in1 in2: Z),
      (/[in0] : word) <> /[in2] ->
      (/[in1] : word) <> /[in2] ->
      (negb (Zmod.eqb /[in0] (/[in2] : word)) && negb (Zmod.eqb /[in1] (/[in2] : word)))%bool = true.
  Proof. intros. rzify_lia. Succeed Qed. Abort.
