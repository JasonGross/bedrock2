...
Ltac wordOps_to_ZModArith_getEq t :=
  ...
  | context[@Zmod.unsigned (2 ^ ?w) (Zmod.or ?x ?y)] => constr:(@bits.unsigned_or w x y)
  | context[@Zmod.unsigned (2 ^ ?w) (Zmod.and ?x ?y)] => constr:(@bits.unsigned_and w x y)
  | context[@Zmod.unsigned (2 ^ ?w) (Zmod.xor ?x ?y)] => constr:(@bits.unsigned_xor w x y)
